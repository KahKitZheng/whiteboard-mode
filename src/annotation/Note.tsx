...
/**
 * A sticky note: coloured paper with a textarea on it. The words live in the
 * shape; typing is local until the note is left, so one edit is one undo. The
 * strip along the top is not a control, so the select tool has somewhere to
 * take hold of it — a tap on the paper itself is a tap on the textarea.
 */
